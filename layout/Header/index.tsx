          ...
          <div className="flex items-center gap-3">
            {!profile ? (
              <>
                <Link
                  href="/auth/signin"
                  className="rounded-md border border-primary px-4 py-2 text-sm font-medium text-black hover:text-primary dark:text-white dark:hover:text-primary"
                >
                  Sign In
                </Link>
                <Link
                  href="/auth/signup"
                  className="rounded-md border border-primary px-4 py-2 text-sm font-medium text-brand-500 hover:text-brand-600 dark:text-brand-400"
                >
                  Sign Up
                </Link>
              </>
