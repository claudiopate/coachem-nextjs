...
const Calendar: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setEvents([
     ...
     // Ottieni la data locale nel formato corretto per datetime-local (YYYY-MM-DDTHH:mm)
  ...
  const handleDateSelect = (selectInfo: DateSelectArg) => {
    ...
    const localStartDate = formatDateForLocalInput(startDate);
    const localEndDate = formatDateForLocalInput(endDate);

    // Imposta le date per l'input
  ...
  const handleEventClick = (clickInfo: EventClickArg) => {
    ...
    // Imposta le date formattate come datetime-local (locale)
    setEventStartDate(localStartDate);
    setEventEndDate(localEndDate);
